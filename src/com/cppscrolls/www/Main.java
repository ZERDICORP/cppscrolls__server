...
public class Main
{
  public static void main(String[] args)
  {
    ...
    server.addHandler(new Handler_SignIn());
		...
		server.addHandler(new Handler_ConfirmPasswordUpdate());
		...
		server.addHandler(new Handler_ConfirmAccountDeletion());
